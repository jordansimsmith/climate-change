...
namespace World {
    ...
    public class Resource {
        ...
        private readonly Dictionary<ResourceType, List<ResourceEventHandler>> subscribers =
            new Dictionary<ResourceType, List<ResourceEventHandler>>();
        ...
        public int CurAmount {
            ...
            set {
                ...
                List<ResourceEventHandler> handlers = subscribers[type];
        ...
        public void Subscribe(ResourceType resourceType, ResourceEventHandler handler) {
            List<ResourceEventHandler> handlers = subscribers[resourceType] ?? new List<ResourceEventHandler>();
            handlers.Add(handler);
            subscribers.Add(resourceType, handlers);
        }
    }
}