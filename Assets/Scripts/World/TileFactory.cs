...
namespace World {
   ...
   public class TileFactory : ScriptableObject {
      ...
      public Tile Get(TileType tileType) {
         switch (tileType){
            case TileType.Grass: return Instantiate(grassPrefab);
            case TileType.Sand: return Instantiate(sandPrefab);
            case TileType.Water: return Instantiate(waterPrefab);
            case TileType.Mountain: return Instantiate(mountainPrefab);
            default: 
